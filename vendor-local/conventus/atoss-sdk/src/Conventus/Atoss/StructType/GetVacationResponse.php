...
/**
 * This class stands for getVacationResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getVacationResponse
 * @subpackage Structs
 */
class GetVacationResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getVacationResponse
     * @uses GetVacationResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetVacationResponse
     */
