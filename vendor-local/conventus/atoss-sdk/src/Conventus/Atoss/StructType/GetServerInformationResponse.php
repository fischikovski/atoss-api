...
/**
 * This class stands for getServerInformationResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getServerInformationResponse
 * @subpackage Structs
 */
class GetServerInformationResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getServerInformationResponse
     * @uses GetServerInformationResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetServerInformationResponse
     */
