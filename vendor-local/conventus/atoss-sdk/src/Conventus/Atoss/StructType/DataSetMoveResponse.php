...
/**
 * This class stands for dataSetMoveResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetMoveResponse
 * @subpackage Structs
 */
class DataSetMoveResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetMoveResponse
     * @uses DataSetMoveResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetMoveResponse
     */
