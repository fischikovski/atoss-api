...
/**
 * This class stands for getMessagesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getMessagesResponse
 * @subpackage Structs
 */
class GetMessagesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getMessagesResponse
     * @uses GetMessagesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetMessagesResponse
     */
