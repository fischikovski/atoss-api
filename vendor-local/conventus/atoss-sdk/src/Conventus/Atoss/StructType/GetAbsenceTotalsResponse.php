...
/**
 * This class stands for getAbsenceTotalsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getAbsenceTotalsResponse
 * @subpackage Structs
 */
class GetAbsenceTotalsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getAbsenceTotalsResponse
     * @uses GetAbsenceTotalsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetAbsenceTotalsResponse
     */
