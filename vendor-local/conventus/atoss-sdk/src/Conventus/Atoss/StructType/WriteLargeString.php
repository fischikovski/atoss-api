...
/**
 * This class stands for writeLargeString StructType
 * Meta information extracted from the WSDL
 * - type: tns:writeLargeString
 * @subpackage Structs
 */
class WriteLargeString extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for writeLargeString
     * @uses WriteLargeString::setWorkplace()
     * @uses WriteLargeString::setEmployee()
     * @uses WriteLargeString::setGroup()
     * @uses WriteLargeString::setPath()
     * @uses WriteLargeString::setKey()
     * @uses WriteLargeString::setValue()
     ...
     * @param string $value
     */
    public function __construct(?string $workplace = null, ?string $employee = null, ?int $group = null, ?string $path = null, ?string $key = null, ?string $value = null)
    {
        $this
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\WriteLargeString
     */
