...
/**
 * This class stands for getAbsenceResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getAbsenceResponse
 * @subpackage Structs
 */
class GetAbsenceResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getAbsenceResponse
     * @uses GetAbsenceResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetAbsenceResponse
     */
