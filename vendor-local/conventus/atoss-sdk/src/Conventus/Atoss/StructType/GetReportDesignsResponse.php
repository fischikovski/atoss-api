...
/**
 * This class stands for getReportDesignsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getReportDesignsResponse
 * @subpackage Structs
 */
class GetReportDesignsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getReportDesignsResponse
     * @uses GetReportDesignsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetReportDesignsResponse
     */
