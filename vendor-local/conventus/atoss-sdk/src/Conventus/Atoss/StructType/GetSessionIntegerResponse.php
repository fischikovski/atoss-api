...
/**
 * This class stands for getSessionIntegerResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getSessionIntegerResponse
 * @subpackage Structs
 */
class GetSessionIntegerResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for getSessionIntegerResponse
     * @uses GetSessionIntegerResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\GetSessionIntegerResponse
     */
