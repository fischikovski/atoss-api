...
/**
 * This class stands for getEmployeeGroupsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getEmployeeGroupsResponse
 * @subpackage Structs
 */
class GetEmployeeGroupsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getEmployeeGroupsResponse
     * @uses GetEmployeeGroupsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetEmployeeGroupsResponse
     */
