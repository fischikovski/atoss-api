...
/**
 * This class stands for getReportParametersResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getReportParametersResponse
 * @subpackage Structs
 */
class GetReportParametersResponse extends AbstractStructBase
{
     ...
     * @uses GetReportParametersResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetReportParametersResponse
     */
