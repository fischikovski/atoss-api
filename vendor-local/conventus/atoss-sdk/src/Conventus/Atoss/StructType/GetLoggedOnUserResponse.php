...
/**
 * This class stands for getLoggedOnUserResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getLoggedOnUserResponse
 * @subpackage Structs
 */
class GetLoggedOnUserResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getLoggedOnUserResponse
     * @uses GetLoggedOnUserResponse::setReturn()
     * @param string $return
     */
     ...
     * Set return value
     * @param string $return
     * @return \Conventus\Atoss\StructType\GetLoggedOnUserResponse
     */
