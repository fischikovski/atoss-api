...
/**
 * This class stands for transferPlanningPatternIgnoreExistingResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanningPatternIgnoreExistingResponse
 * @subpackage Structs
 */
class TransferPlanningPatternIgnoreExistingResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanningPatternIgnoreExistingResponse
     * @uses TransferPlanningPatternIgnoreExistingResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\TransferPlanningPatternIgnoreExistingResponse
     */
