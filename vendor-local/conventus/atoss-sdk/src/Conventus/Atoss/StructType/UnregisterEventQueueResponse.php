...
/**
 * This class stands for unregisterEventQueueResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:unregisterEventQueueResponse
 * @subpackage Structs
 */
class UnregisterEventQueueResponse extends AbstractStructBase
{
    /**
     * The return
     * @var bool|null
    ...
    /**
     * Constructor method for unregisterEventQueueResponse
     * @uses UnregisterEventQueueResponse::setReturn()
     * @param bool $return
     */
