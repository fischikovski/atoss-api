...
/**
 * This class stands for getTableFieldsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getTableFieldsResponse
 * @subpackage Structs
 */
class GetTableFieldsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getTableFieldsResponse
     * @uses GetTableFieldsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetTableFieldsResponse
     */
