...
/**
 * This class stands for readString StructType
 * Meta information extracted from the WSDL
 * - type: tns:readString
 * @subpackage Structs
 */
class ReadString extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readString
     * @uses ReadString::setWorkplace()
     * @uses ReadString::setEmployee()
     * @uses ReadString::setGroup()
     * @uses ReadString::setPath()
     * @uses ReadString::setKey()
     * @uses ReadString::setDefvalue()
     * @uses ReadString::setNonhierarchic()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\ReadString
     */
