...
/**
 * This class stands for dataSetCountResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetCountResponse
 * @subpackage Structs
 */
class DataSetCountResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for dataSetCountResponse
     * @uses DataSetCountResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\DataSetCountResponse
     */
