...
/**
 * This class stands for getReportEntitiesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getReportEntitiesResponse
 * @subpackage Structs
 */
class GetReportEntitiesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getReportEntitiesResponse
     * @uses GetReportEntitiesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetReportEntitiesResponse
     */
