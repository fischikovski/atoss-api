...
/**
 * This class stands for setApplicationPropertyString StructType
 * Meta information extracted from the WSDL
 * - type: tns:setApplicationPropertyString
 * @subpackage Structs
 */
class SetApplicationPropertyString extends AbstractStructBase
{
    /**
     * The application
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for setApplicationPropertyString
     * @uses SetApplicationPropertyString::setApplication()
     * @uses SetApplicationPropertyString::setProperty()
     * @uses SetApplicationPropertyString::setIndex()
     * @uses SetApplicationPropertyString::setValue()
     ...
     * @param string $application
     * @return \Conventus\Atoss\StructType\SetApplicationPropertyString
     */
