...
/**
 * This class stands for dateTimeProperties StructType
 * @subpackage Structs
 */
class DateTimeProperties extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for dateTimeProperties
     * @uses DateTimeProperties::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $dateTimePropertiesEntryItem) {
            // validation for constraint: itemType
            if (!$dateTimePropertiesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($dateTimePropertiesEntryItem) ? get_class($dateTimePropertiesEntryItem) : sprintf('%s(%s)', gettype($dateTimePropertiesEntryItem), var_export($dateTimePropertiesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\DateTimeProperties
     */
