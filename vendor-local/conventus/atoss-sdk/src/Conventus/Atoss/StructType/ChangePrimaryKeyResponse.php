...
/**
 * This class stands for changePrimaryKeyResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:changePrimaryKeyResponse
 * @subpackage Structs
 */
class ChangePrimaryKeyResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for changePrimaryKeyResponse
     * @uses ChangePrimaryKeyResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\ChangePrimaryKeyResponse
     */
