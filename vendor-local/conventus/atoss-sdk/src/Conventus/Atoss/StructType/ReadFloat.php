...
/**
 * This class stands for readFloat StructType
 * Meta information extracted from the WSDL
 * - type: tns:readFloat
 * @subpackage Structs
 */
class ReadFloat extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readFloat
     * @uses ReadFloat::setWorkplace()
     * @uses ReadFloat::setEmployee()
     * @uses ReadFloat::setGroup()
     * @uses ReadFloat::setPath()
     * @uses ReadFloat::setKey()
     * @uses ReadFloat::setDefvalue()
     * @uses ReadFloat::setNonhierarchic()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\ReadFloat
     */
