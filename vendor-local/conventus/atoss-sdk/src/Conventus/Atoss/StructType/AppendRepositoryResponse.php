...
/**
 * This class stands for appendRepositoryResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:appendRepositoryResponse
 * @subpackage Structs
 */
class AppendRepositoryResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for appendRepositoryResponse
     * @uses AppendRepositoryResponse::setReturn()
     * @param string $return
     */
     ...
     * Set return value
     * @param string $return
     * @return \Conventus\Atoss\StructType\AppendRepositoryResponse
     */
