...
/**
 * This class stands for getMonthlyReportResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getMonthlyReportResponse
 * @subpackage Structs
 */
class GetMonthlyReportResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getMonthlyReportResponse
     * @uses GetMonthlyReportResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetMonthlyReportResponse
     */
