...
/**
 * This class stands for getUserWorkflowsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getUserWorkflowsResponse
 * @subpackage Structs
 */
class GetUserWorkflowsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getUserWorkflowsResponse
     * @uses GetUserWorkflowsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetUserWorkflowsResponse
     */
