...
/**
 * This class stands for getAbsenceChangeLogsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getAbsenceChangeLogsResponse
 * @subpackage Structs
 */
class GetAbsenceChangeLogsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getAbsenceChangeLogsResponse
     * @uses GetAbsenceChangeLogsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetAbsenceChangeLogsResponse
     */
