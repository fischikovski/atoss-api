...
/**
 * This class stands for startExternalImportResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:startExternalImportResponse
 * @subpackage Structs
 */
class StartExternalImportResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for startExternalImportResponse
     * @uses StartExternalImportResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\StartExternalImportResponse
     */
