...
/**
 * This class stands for getFileFromUserHomeResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getFileFromUserHomeResponse
 * @subpackage Structs
 */
class GetFileFromUserHomeResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getFileFromUserHomeResponse
     * @uses GetFileFromUserHomeResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetFileFromUserHomeResponse
     */
