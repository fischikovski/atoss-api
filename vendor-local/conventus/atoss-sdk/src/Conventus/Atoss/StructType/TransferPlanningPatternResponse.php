...
/**
 * This class stands for transferPlanningPatternResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanningPatternResponse
 * @subpackage Structs
 */
class TransferPlanningPatternResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanningPatternResponse
     * @uses TransferPlanningPatternResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\TransferPlanningPatternResponse
     */
