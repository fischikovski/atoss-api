...
/**
 * This class stands for unlockWorkplaceSales StructType
 * Meta information extracted from the WSDL
 * - type: tns:unlockWorkplaceSales
 * @subpackage Structs
 */
class UnlockWorkplaceSales extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for unlockWorkplaceSales
     * @uses UnlockWorkplaceSales::setWorkplace()
     * @uses UnlockWorkplaceSales::setFromdate()
     * @uses UnlockWorkplaceSales::setTodate()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\UnlockWorkplaceSales
     */
