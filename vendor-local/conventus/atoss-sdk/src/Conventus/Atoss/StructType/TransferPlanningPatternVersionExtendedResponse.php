...
/**
 * This class stands for transferPlanningPatternVersionExtendedResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanningPatternVersionExtendedResponse
 * @subpackage Structs
 */
class TransferPlanningPatternVersionExtendedResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanningPatternVersionExtendedResponse
     * @uses TransferPlanningPatternVersionExtendedResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\TransferPlanningPatternVersionExtendedResponse
     */
