...
/**
 * This class stands for enumRunningTasksResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:enumRunningTasksResponse
 * @subpackage Structs
 */
class EnumRunningTasksResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for enumRunningTasksResponse
     * @uses EnumRunningTasksResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\EnumRunningTasksResponse
     */
