...
/**
 * This class stands for createManningLevelExtendedResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:createManningLevelExtendedResponse
 * @subpackage Structs
 */
class CreateManningLevelExtendedResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for createManningLevelExtendedResponse
     * @uses CreateManningLevelExtendedResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\CreateManningLevelExtendedResponse
     */
