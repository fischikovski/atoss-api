...
/**
 * This class stands for dataSetDelete StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetDelete
 * @subpackage Structs
 */
class DataSetDelete extends AbstractStructBase
{
    /**
     * The dataset
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetDelete
     * @uses DataSetDelete::setDataset()
     * @uses DataSetDelete::setFilter()
     ...
     * Set dataset value
     * @param string $dataset
     * @return \Conventus\Atoss\StructType\DataSetDelete
     */
