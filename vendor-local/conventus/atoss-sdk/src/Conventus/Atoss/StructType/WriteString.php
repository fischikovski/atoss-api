...
/**
 * This class stands for writeString StructType
 * Meta information extracted from the WSDL
 * - type: tns:writeString
 * @subpackage Structs
 */
class WriteString extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for writeString
     * @uses WriteString::setWorkplace()
     * @uses WriteString::setEmployee()
     * @uses WriteString::setGroup()
     * @uses WriteString::setPath()
     * @uses WriteString::setKey()
     * @uses WriteString::setValue()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\WriteString
     */
