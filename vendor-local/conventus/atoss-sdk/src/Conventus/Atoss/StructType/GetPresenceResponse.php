...
/**
 * This class stands for getPresenceResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getPresenceResponse
 * @subpackage Structs
 */
class GetPresenceResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getPresenceResponse
     * @uses GetPresenceResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetPresenceResponse
     */
