...
/**
 * This class stands for getLastMessage StructType
 * Meta information extracted from the WSDL
 * - type: tns:getLastMessage
 * @subpackage Structs
 */
class GetLastMessage extends AbstractStructBase
{
    /**
     * The employee
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getLastMessage
     * @uses GetLastMessage::setEmployee()
     * @uses GetLastMessage::setState()
     ...
     * Set employee value
     * @param string $employee
     * @return \Conventus\Atoss\StructType\GetLastMessage
     */
