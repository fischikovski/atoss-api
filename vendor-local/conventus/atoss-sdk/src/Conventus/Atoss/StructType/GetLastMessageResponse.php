...
/**
 * This class stands for getLastMessageResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getLastMessageResponse
 * @subpackage Structs
 */
class GetLastMessageResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getLastMessageResponse
     * @uses GetLastMessageResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetLastMessageResponse
     */
