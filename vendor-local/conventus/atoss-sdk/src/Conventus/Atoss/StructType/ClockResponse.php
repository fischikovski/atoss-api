...
/**
 * This class stands for clockResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:clockResponse
 * @subpackage Structs
 */
class ClockResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for clockResponse
     * @uses ClockResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\ClockResponse
     */
