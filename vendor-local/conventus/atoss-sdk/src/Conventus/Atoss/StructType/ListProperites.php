...
/**
 * This class stands for listProperites StructType
 * @subpackage Structs
 */
class ListProperites extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for listProperites
     * @uses ListProperites::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $listProperitesEntryItem) {
            // validation for constraint: itemType
            if (!$listProperitesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($listProperitesEntryItem) ? get_class($listProperitesEntryItem) : sprintf('%s(%s)', gettype($listProperitesEntryItem), var_export($listProperitesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\ListProperites
     */
