...
/**
 * This class stands for getActiveFollowUpApplicationsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getActiveFollowUpApplicationsResponse
 * @subpackage Structs
 */
class GetActiveFollowUpApplicationsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getActiveFollowUpApplicationsResponse
     * @uses GetActiveFollowUpApplicationsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetActiveFollowUpApplicationsResponse
     */
