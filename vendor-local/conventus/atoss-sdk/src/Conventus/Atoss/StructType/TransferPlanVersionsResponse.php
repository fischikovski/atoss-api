...
/**
 * This class stands for transferPlanVersionsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanVersionsResponse
 * @subpackage Structs
 */
class TransferPlanVersionsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanVersionsResponse
     * @uses TransferPlanVersionsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\TransferPlanVersionsResponse
     */
