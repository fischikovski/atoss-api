...
/**
 * This class stands for getDepartmentsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getDepartmentsResponse
 * @subpackage Structs
 */
class GetDepartmentsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getDepartmentsResponse
     * @uses GetDepartmentsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetDepartmentsResponse
     */
