...
/**
 * This class stands for dataSetUpdateWithResult StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetUpdateWithResult
 * @subpackage Structs
 */
class DataSetUpdateWithResult extends AbstractStructBase
{
    /**
     * The dataset
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetUpdateWithResult
     * @uses DataSetUpdateWithResult::setDataset()
     * @uses DataSetUpdateWithResult::setRecord()
     * @uses DataSetUpdateWithResult::setFilter()
     ...
     * Set dataset value
     * @param string $dataset
     * @return \Conventus\Atoss\StructType\DataSetUpdateWithResult
     */
