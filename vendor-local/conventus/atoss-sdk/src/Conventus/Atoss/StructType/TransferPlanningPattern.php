...
/**
 * This class stands for transferPlanningPattern StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanningPattern
 * @subpackage Structs
 */
class TransferPlanningPattern extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanningPattern
     * @uses TransferPlanningPattern::setWorkplace()
     * @uses TransferPlanningPattern::setModel()
     * @uses TransferPlanningPattern::setVersion()
     * @uses TransferPlanningPattern::setFrom()
     * @uses TransferPlanningPattern::setTo()
     * @uses TransferPlanningPattern::setWhat()
     * @uses TransferPlanningPattern::setTransferindependent()
     ...
     */
    public function __construct(?string $workplace = null, ?int $model = null, ?int $version = null, ?string $from = null, ?string $to = null, ?int $what = null, ?int $transferindependent = null)
    {
        $this
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\TransferPlanningPattern
     */
