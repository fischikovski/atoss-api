...
/**
 * This class stands for deleteEmployeeResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:deleteEmployeeResponse
 * @subpackage Structs
 */
class DeleteEmployeeResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for deleteEmployeeResponse
     * @uses DeleteEmployeeResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\DeleteEmployeeResponse
     */
