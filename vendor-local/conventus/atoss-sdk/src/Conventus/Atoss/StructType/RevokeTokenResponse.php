...
/**
 * This class stands for revokeTokenResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:revokeTokenResponse
 * @subpackage Structs
 */
class RevokeTokenResponse extends AbstractStructBase
{
    /**
     * The return
     * @var bool|null
    ...
    /**
     * Constructor method for revokeTokenResponse
     * @uses RevokeTokenResponse::setReturn()
     * @param bool $return
     */
