...
/**
 * This class stands for readXMLResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:readXMLResponse
 * @subpackage Structs
 */
class ReadXMLResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readXMLResponse
     * @uses ReadXMLResponse::setReturn()
     * @param string $return
     */
     ...
     * Set return value
     * @param string $return
     * @return \Conventus\Atoss\StructType\ReadXMLResponse
     */
