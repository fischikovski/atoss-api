...
/**
 * This class stands for readLargeString StructType
 * Meta information extracted from the WSDL
 * - type: tns:readLargeString
 * @subpackage Structs
 */
class ReadLargeString extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readLargeString
     * @uses ReadLargeString::setWorkplace()
     * @uses ReadLargeString::setEmployee()
     * @uses ReadLargeString::setGroup()
     * @uses ReadLargeString::setPath()
     * @uses ReadLargeString::setKey()
     * @uses ReadLargeString::setDefvalue()
     * @uses ReadLargeString::setNonhierarchic()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\ReadLargeString
     */
