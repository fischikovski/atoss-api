...
/**
 * This class stands for getRepositoryResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getRepositoryResponse
 * @subpackage Structs
 */
class GetRepositoryResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getRepositoryResponse
     * @uses GetRepositoryResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetRepositoryResponse
     */
