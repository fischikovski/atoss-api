...
/**
 * This class stands for durationProperties StructType
 * @subpackage Structs
 */
class DurationProperties extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for durationProperties
     * @uses DurationProperties::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $durationPropertiesEntryItem) {
            // validation for constraint: itemType
            if (!$durationPropertiesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($durationPropertiesEntryItem) ? get_class($durationPropertiesEntryItem) : sprintf('%s(%s)', gettype($durationPropertiesEntryItem), var_export($durationPropertiesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\DurationProperties
     */
