...
/**
 * This class stands for dumpTableResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dumpTableResponse
 * @subpackage Structs
 */
class DumpTableResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dumpTableResponse
     * @uses DumpTableResponse::setReturn()
     * @param string $return
     */
