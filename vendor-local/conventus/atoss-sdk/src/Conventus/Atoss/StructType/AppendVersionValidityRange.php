...
/**
 * This class stands for appendVersionValidityRange StructType
 * Meta information extracted from the WSDL
 * - type: tns:appendVersionValidityRange
 * @subpackage Structs
 */
class AppendVersionValidityRange extends AbstractStructBase
{
    /**
     * The table
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for appendVersionValidityRange
     * @uses AppendVersionValidityRange::setTable()
     * @uses AppendVersionValidityRange::setKey()
     * @uses AppendVersionValidityRange::setValidfrom()
     * @uses AppendVersionValidityRange::setValidto()
     * @param string $table
     ...
     * Set table value
     * @param string $table
     * @return \Conventus\Atoss\StructType\AppendVersionValidityRange
     */
