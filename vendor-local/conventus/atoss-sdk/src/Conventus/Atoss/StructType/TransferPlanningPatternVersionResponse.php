...
/**
 * This class stands for transferPlanningPatternVersionResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanningPatternVersionResponse
 * @subpackage Structs
 */
class TransferPlanningPatternVersionResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanningPatternVersionResponse
     * @uses TransferPlanningPatternVersionResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\TransferPlanningPatternVersionResponse
     */
