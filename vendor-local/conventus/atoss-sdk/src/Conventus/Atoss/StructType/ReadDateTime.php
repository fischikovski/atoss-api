...
/**
 * This class stands for readDateTime StructType
 * Meta information extracted from the WSDL
 * - type: tns:readDateTime
 * @subpackage Structs
 */
class ReadDateTime extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readDateTime
     * @uses ReadDateTime::setWorkplace()
     * @uses ReadDateTime::setEmployee()
     * @uses ReadDateTime::setGroup()
     * @uses ReadDateTime::setPath()
     * @uses ReadDateTime::setKey()
     * @uses ReadDateTime::setDefvalue()
     * @uses ReadDateTime::setNonhierarchic()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\ReadDateTime
     */
