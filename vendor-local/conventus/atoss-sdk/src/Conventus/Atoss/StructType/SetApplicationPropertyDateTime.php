...
/**
 * This class stands for setApplicationPropertyDateTime StructType
 * Meta information extracted from the WSDL
 * - type: tns:setApplicationPropertyDateTime
 * @subpackage Structs
 */
class SetApplicationPropertyDateTime extends AbstractStructBase
{
    /**
     * The application
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for setApplicationPropertyDateTime
     * @uses SetApplicationPropertyDateTime::setApplication()
     * @uses SetApplicationPropertyDateTime::setProperty()
     * @uses SetApplicationPropertyDateTime::setIndex()
     * @uses SetApplicationPropertyDateTime::setValue()
     * @param string $application
     * @param string $property
     * @param int $index
     * @param string $value
     */
    public function __construct(?string $application = null, ?string $property = null, ?int $index = null, ?string $value = null)
    {
        $this
     ...
     * @param string $application
     * @return \Conventus\Atoss\StructType\SetApplicationPropertyDateTime
     */
