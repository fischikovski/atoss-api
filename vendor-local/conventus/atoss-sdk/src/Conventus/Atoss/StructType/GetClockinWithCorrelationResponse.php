...
/**
 * This class stands for getClockinWithCorrelationResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getClockinWithCorrelationResponse
 * @subpackage Structs
 */
class GetClockinWithCorrelationResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getClockinWithCorrelationResponse
     * @uses GetClockinWithCorrelationResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetClockinWithCorrelationResponse
     */
