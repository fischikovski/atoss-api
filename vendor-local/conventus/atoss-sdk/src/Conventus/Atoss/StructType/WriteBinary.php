...
/**
 * This class stands for writeBinary StructType
 * Meta information extracted from the WSDL
 * - type: tns:writeBinary
 * @subpackage Structs
 */
class WriteBinary extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for writeBinary
     * @uses WriteBinary::setWorkplace()
     * @uses WriteBinary::setEmployee()
     * @uses WriteBinary::setGroup()
     * @uses WriteBinary::setPath()
     * @uses WriteBinary::setKey()
     * @uses WriteBinary::setValue()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\WriteBinary
     */
