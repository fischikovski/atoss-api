...
/**
 * This class stands for getRecordCountResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getRecordCountResponse
 * @subpackage Structs
 */
class GetRecordCountResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for getRecordCountResponse
     * @uses GetRecordCountResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\GetRecordCountResponse
     */
