...
/**
 * This class stands for getAccountsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getAccountsResponse
 * @subpackage Structs
 */
class GetAccountsResponse extends AbstractStructBase
{
     ...
     * @uses GetAccountsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetAccountsResponse
     */
