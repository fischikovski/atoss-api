...
/**
 * This class stands for getLastActivityResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getLastActivityResponse
 * @subpackage Structs
 */
class GetLastActivityResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getLastActivityResponse
     * @uses GetLastActivityResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetLastActivityResponse
     */
