...
/**
 * This class stands for getApplicationPropertiesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getApplicationPropertiesResponse
 * @subpackage Structs
 */
class GetApplicationPropertiesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getApplicationPropertiesResponse
     * @uses GetApplicationPropertiesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetApplicationPropertiesResponse
     */
