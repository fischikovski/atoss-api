...
/**
 * This class stands for dataSetCopyResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetCopyResponse
 * @subpackage Structs
 */
class DataSetCopyResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetCopyResponse
     * @uses DataSetCopyResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetCopyResponse
     */
