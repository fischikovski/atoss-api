...
/**
 * This class stands for doubleProperties StructType
 * @subpackage Structs
 */
class DoubleProperties extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for doubleProperties
     * @uses DoubleProperties::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $doublePropertiesEntryItem) {
            // validation for constraint: itemType
            if (!$doublePropertiesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($doublePropertiesEntryItem) ? get_class($doublePropertiesEntryItem) : sprintf('%s(%s)', gettype($doublePropertiesEntryItem), var_export($doublePropertiesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\DoubleProperties
     */
