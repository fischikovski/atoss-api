...
/**
 * This class stands for writeXML StructType
 * Meta information extracted from the WSDL
 * - type: tns:writeXML
 * @subpackage Structs
 */
class WriteXML extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for writeXML
     * @uses WriteXML::setWorkplace()
     * @uses WriteXML::setEmployee()
     * @uses WriteXML::setGroup()
     * @uses WriteXML::setPath()
     * @uses WriteXML::setKey()
     * @uses WriteXML::setValue()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\WriteXML
     */
