...
/**
 * This class stands for binaryProperties StructType
 * @subpackage Structs
 */
class BinaryProperties extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for binaryProperties
     * @uses BinaryProperties::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $binaryPropertiesEntryItem) {
            // validation for constraint: itemType
            if (!$binaryPropertiesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($binaryPropertiesEntryItem) ? get_class($binaryPropertiesEntryItem) : sprintf('%s(%s)', gettype($binaryPropertiesEntryItem), var_export($binaryPropertiesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\BinaryProperties
     */
