...
/**
 * This class stands for integerProperties StructType
 * @subpackage Structs
 */
class IntegerProperties extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for integerProperties
     * @uses IntegerProperties::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $integerPropertiesEntryItem) {
            // validation for constraint: itemType
            if (!$integerPropertiesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($integerPropertiesEntryItem) ? get_class($integerPropertiesEntryItem) : sprintf('%s(%s)', gettype($integerPropertiesEntryItem), var_export($integerPropertiesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\IntegerProperties
     */
