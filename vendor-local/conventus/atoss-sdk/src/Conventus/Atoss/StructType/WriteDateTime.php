...
/**
 * This class stands for writeDateTime StructType
 * Meta information extracted from the WSDL
 * - type: tns:writeDateTime
 * @subpackage Structs
 */
class WriteDateTime extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for writeDateTime
     * @uses WriteDateTime::setWorkplace()
     * @uses WriteDateTime::setEmployee()
     * @uses WriteDateTime::setGroup()
     * @uses WriteDateTime::setPath()
     * @uses WriteDateTime::setKey()
     * @uses WriteDateTime::setValue()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\WriteDateTime
     */
