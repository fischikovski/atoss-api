...
/**
 * This class stands for getFreeBalanceValuesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getFreeBalanceValuesResponse
 * @subpackage Structs
 */
class GetFreeBalanceValuesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getFreeBalanceValuesResponse
     * @uses GetFreeBalanceValuesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetFreeBalanceValuesResponse
     */
