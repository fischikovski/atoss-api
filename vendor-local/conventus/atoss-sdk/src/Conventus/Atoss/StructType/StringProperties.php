...
/**
 * This class stands for stringProperties StructType
 * @subpackage Structs
 */
class StringProperties extends AbstractStructBase
{
    /**
     * The entry
    ...
    /**
     * Constructor method for stringProperties
     * @uses StringProperties::setEntry()
    ...
    public static function validateEntryForArrayConstraintsFromSetEntry(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $stringPropertiesEntryItem) {
            // validation for constraint: itemType
            if (!$stringPropertiesEntryItem instanceof \Conventus\Atoss\StructType\Entry) {
                $invalidValues[] = is_object($stringPropertiesEntryItem) ? get_class($stringPropertiesEntryItem) : sprintf('%s(%s)', gettype($stringPropertiesEntryItem), var_export($stringPropertiesEntryItem, true));
            }
        }
     ...
     * @param \Conventus\Atoss\StructType\Entry[] $entry
     * @return \Conventus\Atoss\StructType\StringProperties
     */
