...
/**
 * This class stands for getVacationYearRecordsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getVacationYearRecordsResponse
 * @subpackage Structs
 */
class GetVacationYearRecordsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getVacationYearRecordsResponse
     * @uses GetVacationYearRecordsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetVacationYearRecordsResponse
     */
