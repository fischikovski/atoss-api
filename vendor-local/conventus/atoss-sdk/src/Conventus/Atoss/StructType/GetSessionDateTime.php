...
/**
 * This class stands for getSessionDateTime StructType
 * Meta information extracted from the WSDL
 * - type: tns:getSessionDateTime
 * @subpackage Structs
 */
class GetSessionDateTime extends AbstractStructBase
{
    /**
     * The scope
     * @var int|null
    ...
    /**
     * Constructor method for getSessionDateTime
     * @uses GetSessionDateTime::setScope()
     * @uses GetSessionDateTime::setVariable()
     * @uses GetSessionDateTime::setDefvalue()
     * @param int $scope
     ...
     * Set scope value
     * @param int $scope
     * @return \Conventus\Atoss\StructType\GetSessionDateTime
     */
