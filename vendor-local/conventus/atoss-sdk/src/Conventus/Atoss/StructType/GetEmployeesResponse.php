...
/**
 * This class stands for getEmployeesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getEmployeesResponse
 * @subpackage Structs
 */
class GetEmployeesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getEmployeesResponse
     * @uses GetEmployeesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetEmployeesResponse
     */
