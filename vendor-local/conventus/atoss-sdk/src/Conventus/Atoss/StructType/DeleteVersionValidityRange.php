...
/**
 * This class stands for deleteVersionValidityRange StructType
 * Meta information extracted from the WSDL
 * - type: tns:deleteVersionValidityRange
 * @subpackage Structs
 */
class DeleteVersionValidityRange extends AbstractStructBase
{
    /**
     * The table
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for deleteVersionValidityRange
     * @uses DeleteVersionValidityRange::setTable()
     * @uses DeleteVersionValidityRange::setKey()
     * @uses DeleteVersionValidityRange::setValidfrom()
     * @uses DeleteVersionValidityRange::setValidto()
     * @param string $table
     ...
     * Set table value
     * @param string $table
     * @return \Conventus\Atoss\StructType\DeleteVersionValidityRange
     */
