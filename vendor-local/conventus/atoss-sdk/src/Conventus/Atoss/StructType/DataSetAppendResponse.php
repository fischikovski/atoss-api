...
/**
 * This class stands for dataSetAppendResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetAppendResponse
 * @subpackage Structs
 */
class DataSetAppendResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetAppendResponse
     * @uses DataSetAppendResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetAppendResponse
     */
