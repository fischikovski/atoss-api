...
/**
 * This class stands for getFreeBalancesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getFreeBalancesResponse
 * @subpackage Structs
 */
class GetFreeBalancesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getFreeBalancesResponse
     * @uses GetFreeBalancesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetFreeBalancesResponse
     */
