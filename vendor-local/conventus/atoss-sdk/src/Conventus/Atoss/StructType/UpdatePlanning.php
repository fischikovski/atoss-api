...
/**
 * This class stands for updatePlanning StructType
 * Meta information extracted from the WSDL
 * - type: tns:updatePlanning
 * @subpackage Structs
 */
class UpdatePlanning extends AbstractStructBase
{
    /**
     * The date
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for updatePlanning
     * @uses UpdatePlanning::setDate()
     * @uses UpdatePlanning::setFrom()
     * @uses UpdatePlanning::setTo()
     * @uses UpdatePlanning::setPause()
     * @uses UpdatePlanning::setPausestart()
     * @uses UpdatePlanning::setShift()
     * @uses UpdatePlanning::setQualification()
     * @uses UpdatePlanning::setEfficiency()
     * @uses UpdatePlanning::setWorkplace()
     * @uses UpdatePlanning::setProject()
     * @uses UpdatePlanning::setRhythm()
     * @uses UpdatePlanning::setEmployee()
     * @uses UpdatePlanning::setAccount()
     * @uses UpdatePlanning::setVersion()
     * @uses UpdatePlanning::setMguid()
     * @uses UpdatePlanning::setGuid()
     * @uses UpdatePlanning::setRemark()
     * @uses UpdatePlanning::setShortcut()
     * @uses UpdatePlanning::setDescription()
     * @uses UpdatePlanning::setOptions()
     * @param string $date
     * @param string $from
     * @param string $to
     * @param float $pause
     ...
     * Set date value
     * @param string $date
     * @return \Conventus\Atoss\StructType\UpdatePlanning
     */
