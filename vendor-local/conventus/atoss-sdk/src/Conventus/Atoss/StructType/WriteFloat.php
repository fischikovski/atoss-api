...
/**
 * This class stands for writeFloat StructType
 * Meta information extracted from the WSDL
 * - type: tns:writeFloat
 * @subpackage Structs
 */
class WriteFloat extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for writeFloat
     * @uses WriteFloat::setWorkplace()
     * @uses WriteFloat::setEmployee()
     * @uses WriteFloat::setGroup()
     * @uses WriteFloat::setPath()
     * @uses WriteFloat::setKey()
     * @uses WriteFloat::setValue()
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\WriteFloat
     */
