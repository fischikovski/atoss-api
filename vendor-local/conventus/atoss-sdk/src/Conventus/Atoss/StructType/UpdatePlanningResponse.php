...
/**
 * This class stands for updatePlanningResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:updatePlanningResponse
 * @subpackage Structs
 */
class UpdatePlanningResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for updatePlanningResponse
     * @uses UpdatePlanningResponse::setReturn()
     * @param string $return
     */
     ...
     * Set return value
     * @param string $return
     * @return \Conventus\Atoss\StructType\UpdatePlanningResponse
     */
