...
/**
 * This class stands for transferPlanningPatternVersion StructType
 * Meta information extracted from the WSDL
 * - type: tns:transferPlanningPatternVersion
 * @subpackage Structs
 */
class TransferPlanningPatternVersion extends AbstractStructBase
{
    /**
     * The workplace
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for transferPlanningPatternVersion
     * @uses TransferPlanningPatternVersion::setWorkplace()
     * @uses TransferPlanningPatternVersion::setModel()
     * @uses TransferPlanningPatternVersion::setVersion()
     * @uses TransferPlanningPatternVersion::setFrom()
     * @uses TransferPlanningPatternVersion::setTo()
     * @uses TransferPlanningPatternVersion::setWhat()
     * @uses TransferPlanningPatternVersion::setTransferindependent()
     * @uses TransferPlanningPatternVersion::setKeepExisting()
     * @uses TransferPlanningPatternVersion::setRequirementsplanversion()
     ...
     */
    public function __construct(?string $workplace = null, ?int $model = null, ?int $version = null, ?string $from = null, ?string $to = null, ?int $what = null, ?int $transferindependent = null, ?bool $keepExisting = null, ?int $requirementsplanversion = null)
    {
        $this
     ...
     * Set workplace value
     * @param string $workplace
     * @return \Conventus\Atoss\StructType\TransferPlanningPatternVersion
     */
