...
/**
 * This class stands for dataSetAppendBatchedResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetAppendBatchedResponse
 * @subpackage Structs
 */
class DataSetAppendBatchedResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetAppendBatchedResponse
     * @uses DataSetAppendBatchedResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetAppendBatchedResponse
     */
