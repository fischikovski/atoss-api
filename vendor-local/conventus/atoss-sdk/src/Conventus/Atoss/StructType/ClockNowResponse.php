...
/**
 * This class stands for clockNowResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:clockNowResponse
 * @subpackage Structs
 */
class ClockNowResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for clockNowResponse
     * @uses ClockNowResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\ClockNowResponse
     */
