...
/**
 * This class stands for dataSetDeleteWithResult StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetDeleteWithResult
 * @subpackage Structs
 */
class DataSetDeleteWithResult extends AbstractStructBase
{
    /**
     * The dataset
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetDeleteWithResult
     * @uses DataSetDeleteWithResult::setDataset()
     * @uses DataSetDeleteWithResult::setFilter()
     ...
     * Set dataset value
     * @param string $dataset
     * @return \Conventus\Atoss\StructType\DataSetDeleteWithResult
     */
