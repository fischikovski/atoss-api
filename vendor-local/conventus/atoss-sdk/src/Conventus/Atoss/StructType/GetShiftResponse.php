...
/**
 * This class stands for getShiftResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getShiftResponse
 * @subpackage Structs
 */
class GetShiftResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getShiftResponse
     * @uses GetShiftResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetShiftResponse
     */
