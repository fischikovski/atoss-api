...
/**
 * This class stands for getApplicationsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getApplicationsResponse
 * @subpackage Structs
 */
class GetApplicationsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses GetApplicationsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetApplicationsResponse
     */
