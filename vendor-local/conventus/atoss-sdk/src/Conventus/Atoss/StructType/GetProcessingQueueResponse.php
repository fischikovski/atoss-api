...
/**
 * This class stands for getProcessingQueueResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getProcessingQueueResponse
 * @subpackage Structs
 */
class GetProcessingQueueResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getProcessingQueueResponse
     * @uses GetProcessingQueueResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetProcessingQueueResponse
     */
