...
/**
 * This class stands for dataSetImportResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetImportResponse
 * @subpackage Structs
 */
class DataSetImportResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetImportResponse
     * @uses DataSetImportResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetImportResponse
     */
