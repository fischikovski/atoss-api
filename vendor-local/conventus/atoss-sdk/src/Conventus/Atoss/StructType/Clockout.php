...
/**
 * This class stands for clockout StructType
 * Meta information extracted from the WSDL
 * - type: tns:clockout
 * @subpackage Structs
 */
class Clockout extends AbstractStructBase
{
    /**
     * The employee
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for clockout
     * @uses Clockout::setEmployee()
     * @uses Clockout::setBadge()
     * @uses Clockout::setTimestamp()
     * @uses Clockout::setDevice()
     * @uses Clockout::setAssignment()
     * @uses Clockout::setAccess()
     * @uses Clockout::setOffline()
     ...
     * @param bool $offline
     */
    public function __construct(?string $employee = null, ?string $badge = null, ?string $timestamp = null, ?int $device = null, ?int $assignment = null, ?int $access = null, ?bool $offline = null)
    {
        $this
     ...
     * Set employee value
     * @param string $employee
     * @return \Conventus\Atoss\StructType\Clockout
     */
