...
/**
 * This class stands for getFreeBalanceValueResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getFreeBalanceValueResponse
 * @subpackage Structs
 */
class GetFreeBalanceValueResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getFreeBalanceValueResponse
     * @uses GetFreeBalanceValueResponse::setReturn()
     * @param float $return
     */
     ...
     * Set return value
     * @param float $return
     * @return \Conventus\Atoss\StructType\GetFreeBalanceValueResponse
     */
