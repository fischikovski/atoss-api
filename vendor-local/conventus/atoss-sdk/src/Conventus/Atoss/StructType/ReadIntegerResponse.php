...
/**
 * This class stands for readIntegerResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:readIntegerResponse
 * @subpackage Structs
 */
class ReadIntegerResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for readIntegerResponse
     * @uses ReadIntegerResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\ReadIntegerResponse
     */
