...
/**
 * This class stands for getPlanningsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getPlanningsResponse
 * @subpackage Structs
 */
class GetPlanningsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getPlanningsResponse
     * @uses GetPlanningsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetPlanningsResponse
     */
