...
/**
 * This class stands for clockinResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:clockinResponse
 * @subpackage Structs
 */
class ClockinResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for clockinResponse
     * @uses ClockinResponse::setReturn()
