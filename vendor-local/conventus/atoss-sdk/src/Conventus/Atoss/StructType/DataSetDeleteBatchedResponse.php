...
/**
 * This class stands for dataSetDeleteBatchedResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetDeleteBatchedResponse
 * @subpackage Structs
 */
class DataSetDeleteBatchedResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetDeleteBatchedResponse
     * @uses DataSetDeleteBatchedResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetDeleteBatchedResponse
     */
