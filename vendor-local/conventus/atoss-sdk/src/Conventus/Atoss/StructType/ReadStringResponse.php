...
/**
 * This class stands for readStringResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:readStringResponse
 * @subpackage Structs
 */
class ReadStringResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readStringResponse
     * @uses ReadStringResponse::setReturn()
     * @param string $return
     */
     ...
     * Set return value
     * @param string $return
     * @return \Conventus\Atoss\StructType\ReadStringResponse
     */
