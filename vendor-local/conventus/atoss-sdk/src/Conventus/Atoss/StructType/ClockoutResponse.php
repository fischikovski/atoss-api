...
/**
 * This class stands for clockoutResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:clockoutResponse
 * @subpackage Structs
 */
class ClockoutResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for clockoutResponse
     * @uses ClockoutResponse::setReturn()
