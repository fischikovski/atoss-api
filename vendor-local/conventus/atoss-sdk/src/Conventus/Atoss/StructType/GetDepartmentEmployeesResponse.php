...
/**
 * This class stands for getDepartmentEmployeesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getDepartmentEmployeesResponse
 * @subpackage Structs
 */
class GetDepartmentEmployeesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getDepartmentEmployeesResponse
     * @uses GetDepartmentEmployeesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetDepartmentEmployeesResponse
     */
