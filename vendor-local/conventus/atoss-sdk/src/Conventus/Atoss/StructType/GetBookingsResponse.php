...
/**
 * This class stands for getBookingsResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getBookingsResponse
 * @subpackage Structs
 */
class GetBookingsResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getBookingsResponse
     * @uses GetBookingsResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetBookingsResponse
     */
