...
/**
 * This class stands for dataSetGetResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetGetResponse
 * @subpackage Structs
 */
class DataSetGetResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetGetResponse
     * @uses DataSetGetResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetGetResponse
     */
