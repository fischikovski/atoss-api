...
/**
 * This class stands for getHolidaysResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getHolidaysResponse
 * @subpackage Structs
 */
class GetHolidaysResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getHolidaysResponse
     * @uses GetHolidaysResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetHolidaysResponse
     */
