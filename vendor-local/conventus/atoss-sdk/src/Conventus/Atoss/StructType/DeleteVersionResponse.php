...
/**
 * This class stands for deleteVersionResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:deleteVersionResponse
 * @subpackage Structs
 */
class DeleteVersionResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for deleteVersionResponse
     * @uses DeleteVersionResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\DeleteVersionResponse
     */
