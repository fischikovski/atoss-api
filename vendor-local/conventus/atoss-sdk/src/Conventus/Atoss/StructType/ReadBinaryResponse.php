...
/**
 * This class stands for readBinaryResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:readBinaryResponse
 * @subpackage Structs
 */
class ReadBinaryResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for readBinaryResponse
     * @uses ReadBinaryResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\ReadBinaryResponse
     */
