...
/**
 * This class stands for getLicenceModulesResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getLicenceModulesResponse
 * @subpackage Structs
 */
class GetLicenceModulesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getLicenceModulesResponse
     * @uses GetLicenceModulesResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetLicenceModulesResponse
     */
