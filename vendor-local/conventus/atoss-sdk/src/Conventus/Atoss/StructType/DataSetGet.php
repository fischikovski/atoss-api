...
/**
 * This class stands for dataSetGet StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetGet
 * @subpackage Structs
 */
class DataSetGet extends AbstractStructBase
{
    /**
     * The dataset
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetGet
     * @uses DataSetGet::setDataset()
     * @uses DataSetGet::setFilter()
     ...
     * Set dataset value
     * @param string $dataset
     * @return \Conventus\Atoss\StructType\DataSetGet
     */
