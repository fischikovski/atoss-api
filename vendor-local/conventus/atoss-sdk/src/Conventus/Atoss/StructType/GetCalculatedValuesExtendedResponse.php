...
/**
 * This class stands for getCalculatedValuesExtendedResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:getCalculatedValuesExtendedResponse
 * @subpackage Structs
 */
class GetCalculatedValuesExtendedResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for getCalculatedValuesExtendedResponse
     * @uses GetCalculatedValuesExtendedResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\GetCalculatedValuesExtendedResponse
     */
