...
/**
 * This class stands for issueTokenResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:issueTokenResponse
 * @subpackage Structs
 */
class IssueTokenResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for issueTokenResponse
     * @uses IssueTokenResponse::setReturn()
     * @param string $return
     */
