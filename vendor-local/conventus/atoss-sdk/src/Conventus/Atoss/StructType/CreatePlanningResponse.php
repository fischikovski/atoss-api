...
/**
 * This class stands for createPlanningResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:createPlanningResponse
 * @subpackage Structs
 */
class CreatePlanningResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for createPlanningResponse
     * @uses CreatePlanningResponse::setReturn()
     * @param string $return
     */
     ...
     * Set return value
     * @param string $return
     * @return \Conventus\Atoss\StructType\CreatePlanningResponse
     */
