...
/**
 * This class stands for setMessageStateResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:setMessageStateResponse
 * @subpackage Structs
 */
class SetMessageStateResponse extends AbstractStructBase
{
    /**
     * The return
     * @var int|null
    ...
    /**
     * Constructor method for setMessageStateResponse
     * @uses SetMessageStateResponse::setReturn()
     * @param int $return
     */
     ...
     * Set return value
     * @param int $return
     * @return \Conventus\Atoss\StructType\SetMessageStateResponse
     */
