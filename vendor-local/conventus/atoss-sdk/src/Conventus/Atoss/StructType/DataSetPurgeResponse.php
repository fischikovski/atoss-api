...
/**
 * This class stands for dataSetPurgeResponse StructType
 * Meta information extracted from the WSDL
 * - type: tns:dataSetPurgeResponse
 * @subpackage Structs
 */
class DataSetPurgeResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for dataSetPurgeResponse
     * @uses DataSetPurgeResponse::setReturn()
     ...
     * Set return value
     * @param \Conventus\Atoss\StructType\WebPropertyObjectList $return
     * @return \Conventus\Atoss\StructType\DataSetPurgeResponse
     */
